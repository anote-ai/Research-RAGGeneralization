...
def load_consolidated_queries(path=CONSOLIDATED_QUERIES_PATH):
    """
    ...
    Defaults to the full 60-sentence file; pass path= to load a subset
    file (e.g. the 20-sentence consolidated file) instead.
    """
    queries = []
